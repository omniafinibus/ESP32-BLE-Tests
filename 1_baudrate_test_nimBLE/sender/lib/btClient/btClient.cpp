...
void BLE_UpdateSensorBAUDTEST(uint16_t sensorVal) {
  sensorVal = sensorVal | 0x8000;
  uint8_t byteSize[2] = { (sensorVal & 0x00FF), (sensorVal & 0xFF00) >> 8 };
  pRemoteSnsrs->writeValue(byteSize, 2, false);
}
